...
/**
 * Created by pjs984312808 on 2016/6/30.
 */
public class HorizontalScrollRecyclerView extends RecyclerView {
    ...
    public HorizontalScrollRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
...
//
//                    getParent().requestDisallowInterceptTouchEvent(false);
                    else if((distanceX < 0)&& getId()==getAdapter().getItemCount()-1){
